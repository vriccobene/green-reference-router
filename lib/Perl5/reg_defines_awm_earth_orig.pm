#############################################################
#
# Perl register defines file for awm_earth_orig
#
#############################################################

package reg_defines_awm_earth_orig;
...
@EXPORT = qw(
                ...
                AWM_EARTH_BETA_REG
                AWM_EARTH_TARGET_REG
                AWM_EARTH_FLOWS_REG
                AWM_EARTH_SRC_IP_REG
                AWM_EARTH_DST_IP_REG
...
sub AWM_EARTH_BASE_ADDR ()       { 0x2000200; }
sub IN_ARB_BASE_ADDR ()          { 0x2000300; }
sub RATE_LIMIT_0_BASE_ADDR ()    { 0x2000400; }
sub RATE_LIMIT_1_BASE_ADDR ()    { 0x2000440; }
sub RATE_LIMIT_2_BASE_ADDR ()    { 0x2000480; }
sub RATE_LIMIT_3_BASE_ADDR ()    { 0x20004c0; }
...
# Name: awm_earth (AWM_EARTH)
# Description: Registers for AWM-Earth Module
# File: projects/awm_earth_orig/include/awm_earth.xml
sub AWM_EARTH_BETA_REG ()     { 0x2000200;}
sub AWM_EARTH_TARGET_REG ()   { 0x2000204;}
sub AWM_EARTH_FLOWS_REG ()    { 0x2000208;}
sub AWM_EARTH_SRC_IP_REG ()   { 0x200020c;}
sub AWM_EARTH_DST_IP_REG ()   { 0x2000210;}
...
sub RATE_LIMIT_0_ENABLE_REG ()   { 0x2000400;}
sub RATE_LIMIT_0_SHIFT_REG ()    { 0x2000404;}

# Name: rate_limiter (RATE_LIMIT_1)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_1_ENABLE_REG ()   { 0x2000440;}
sub RATE_LIMIT_1_SHIFT_REG ()    { 0x2000444;}

# Name: rate_limiter (RATE_LIMIT_2)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_2_ENABLE_REG ()   { 0x2000480;}
sub RATE_LIMIT_2_SHIFT_REG ()    { 0x2000484;}

# Name: rate_limiter (RATE_LIMIT_3)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_3_ENABLE_REG ()   { 0x20004c0;}
sub RATE_LIMIT_3_SHIFT_REG ()    { 0x20004c4;}
