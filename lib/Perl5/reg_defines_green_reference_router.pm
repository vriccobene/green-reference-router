#############################################################
#
# Perl register defines file for green_reference_router
#
#############################################################

package reg_defines_green_reference_router;
...
@EXPORT = qw(
                ...
                OUTPUT_BITRATE_COMPUTATOR_BASE_ADDR
                INPUT_BITRATE_COMPUTATOR_BASE_ADDR
                BITRATE_EWMA_BASE_ADDR
                ...
                OUTPUT_BITRATE_COMPUTATOR_CYCLE_OUT_REG
                OUTPUT_BITRATE_COMPUTATOR_Q0_BITRATE_OUT_REG
                OUTPUT_BITRATE_COMPUTATOR_Q1_BITRATE_OUT_REG
                OUTPUT_BITRATE_COMPUTATOR_Q2_BITRATE_OUT_REG
                OUTPUT_BITRATE_COMPUTATOR_Q3_BITRATE_OUT_REG
                OUTPUT_BITRATE_COMPUTATOR_TOTAL_BITRATE_OUT_REG
                INPUT_BITRATE_COMPUTATOR_CYCLE_REG
                INPUT_BITRATE_COMPUTATOR_Q0_BITRATE_REG
                INPUT_BITRATE_COMPUTATOR_Q1_BITRATE_REG
                INPUT_BITRATE_COMPUTATOR_Q2_BITRATE_REG
                INPUT_BITRATE_COMPUTATOR_Q3_BITRATE_REG
                INPUT_BITRATE_COMPUTATOR_TOTAL_BITRATE_REG
                BITRATE_EWMA_ALPHA_REG
                BITRATE_EWMA_EWMA_REG
...
sub OUTPUT_BITRATE_COMPUTATOR_BASE_ADDR ()   { 0x2000100; }
sub INPUT_BITRATE_COMPUTATOR_BASE_ADDR ()    { 0x2000140; }
sub BITRATE_EWMA_BASE_ADDR ()                { 0x2000180; }
sub RATE_LIMIT_0_BASE_ADDR ()                { 0x20001c0; }
sub STRIP_HEADERS_BASE_ADDR ()               { 0x2000200; }
sub IN_ARB_BASE_ADDR ()                      { 0x2000300; }
sub RATE_LIMIT_1_BASE_ADDR ()                { 0x2000400; }
sub RATE_LIMIT_2_BASE_ADDR ()                { 0x2000440; }
sub RATE_LIMIT_3_BASE_ADDR ()                { 0x2000480; }
...
sub OUTPUT_BITRATE_COMPUTATOR_CYCLE_OUT_REG ()           { 0x2000100;}
sub OUTPUT_BITRATE_COMPUTATOR_Q0_BITRATE_OUT_REG ()      { 0x2000104;}
sub OUTPUT_BITRATE_COMPUTATOR_Q1_BITRATE_OUT_REG ()      { 0x2000108;}
sub OUTPUT_BITRATE_COMPUTATOR_Q2_BITRATE_OUT_REG ()      { 0x200010c;}
sub OUTPUT_BITRATE_COMPUTATOR_Q3_BITRATE_OUT_REG ()      { 0x2000110;}
sub OUTPUT_BITRATE_COMPUTATOR_TOTAL_BITRATE_OUT_REG ()   { 0x2000114;}
...
sub INPUT_BITRATE_COMPUTATOR_CYCLE_REG ()           { 0x2000140;}
sub INPUT_BITRATE_COMPUTATOR_Q0_BITRATE_REG ()      { 0x2000144;}
sub INPUT_BITRATE_COMPUTATOR_Q1_BITRATE_REG ()      { 0x2000148;}
sub INPUT_BITRATE_COMPUTATOR_Q2_BITRATE_REG ()      { 0x200014c;}
sub INPUT_BITRATE_COMPUTATOR_Q3_BITRATE_REG ()      { 0x2000150;}
sub INPUT_BITRATE_COMPUTATOR_TOTAL_BITRATE_REG ()   { 0x2000154;}
...
sub BITRATE_EWMA_ALPHA_REG ()   { 0x2000180;}
sub BITRATE_EWMA_EWMA_REG ()    { 0x2000184;}

# Name: rate_limiter (RATE_LIMIT_0)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_0_ENABLE_REG ()   { 0x20001c0;}
sub RATE_LIMIT_0_SHIFT_REG ()    { 0x20001c4;}
...
sub IN_ARB_LAST_PKT_CTRL_0_REG ()      { 0x200030c;}
sub IN_ARB_LAST_PKT_WORD_1_HI_REG ()   { 0x2000310;}
sub IN_ARB_LAST_PKT_WORD_1_LO_REG ()   { 0x2000314;}
sub IN_ARB_LAST_PKT_CTRL_1_REG ()      { 0x2000318;}
sub IN_ARB_STATE_REG ()                { 0x200031c;}

# Name: rate_limiter (RATE_LIMIT_1)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_1_ENABLE_REG ()   { 0x2000400;}
sub RATE_LIMIT_1_SHIFT_REG ()    { 0x2000404;}

# Name: rate_limiter (RATE_LIMIT_2)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_2_ENABLE_REG ()   { 0x2000440;}
sub RATE_LIMIT_2_SHIFT_REG ()    { 0x2000444;}

# Name: rate_limiter (RATE_LIMIT_3)
# Description: Event Capture Registers
# File: lib/verilog/core/rate_limiter/xml/rate_limiter.xml
sub RATE_LIMIT_3_ENABLE_REG ()   { 0x2000480;}
sub RATE_LIMIT_3_SHIFT_REG ()    { 0x2000484;}
