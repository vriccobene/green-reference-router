#############################################################
#
# Perl register defines file for flex_router
#
#############################################################

package reg_defines_flex_router;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                FLEX_ROUTER_SRC_IP_REG
                FLEX_ROUTER_DST_IP_REG
                FLEX_ROUTER_SRC_PORT_REG
                FLEX_ROUTER_DST_PORT_REG
                FLEX_ROUTER_WIN_REG
                FLEX_ROUTER_SRC_IP_INIT_REG
                FLEX_ROUTER_DST_IP_INIT_REG
                FLEX_ROUTER_SRC_PORT_INIT_REG
                FLEX_ROUTER_DST_PORT_INIT_REG
                OQ_QUEUE_0_CTRL_REG
...
sub FLEX_ROUTER_BASE_ADDR ()     { 0x2000300; }
...
# Name: flex_router (FLEX_ROUTER)
# Description: Registers for Flex Router Module
# File: projects/flex_router/include/flex_router.xml
sub FLEX_ROUTER_SRC_IP_REG ()          { 0x2000300;}
sub FLEX_ROUTER_DST_IP_REG ()          { 0x2000304;}
sub FLEX_ROUTER_SRC_PORT_REG ()        { 0x2000308;}
sub FLEX_ROUTER_DST_PORT_REG ()        { 0x200030c;}
sub FLEX_ROUTER_WIN_REG ()             { 0x2000310;}
sub FLEX_ROUTER_SRC_IP_INIT_REG ()     { 0x2000314;}
sub FLEX_ROUTER_DST_IP_INIT_REG ()     { 0x2000318;}
sub FLEX_ROUTER_SRC_PORT_INIT_REG ()   { 0x200031c;}
sub FLEX_ROUTER_DST_PORT_INIT_REG ()   { 0x2000320;}
