...
public class RouterDetailsPanel extends PanelWithShapes {
    ...
    private void initializeArrowsComps(Vector<JComponent> startComps, Vector<JComponent> endComps){
        ...
        startComps.add(oplButton); endComps.add(oqButton);
        startComps.add(oqButton); endComps.add(rateLimiterButton0);
        startComps.add(oqButton); endComps.add(rateLimiterButton1);
        startComps.add(oqButton); endComps.add(rateLimiterButton2);
        startComps.add(oqButton); endComps.add(rateLimiterButton3);
        ...
        startComps.add(rateLimiterButton1); endComps.add(macTxQ1Button);//
        startComps.add(rateLimiterButton0); endComps.add(macTxQ0Button);//
        startComps.add(rateLimiterButton2); endComps.add(macTxQ2Button);//
        startComps.add(rateLimiterButton3); endComps.add(macTxQ3Button);//
    }
 ...
 //       evtCapButton = new javax.swing.JButton();
        rateLimiterButton0 = new javax.swing.JButton();
        rateLimiterButton1 = new javax.swing.JButton();
        rateLimiterButton2 = new javax.swing.JButton();
        rateLimiterButton3 = new javax.swing.JButton();
 ...
 rateLimiterButton3.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
               ...
               // .addComponent(evtCapButton, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(54, 54, 54)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rateLimiterButton0, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cpuTxQ0Button, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(rateLimiterButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cpuTxQ1Button, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(rateLimiterButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cpuTxQ2Button, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(rateLimiterButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void rateLimiterButton0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rateLimiterButtonActionPerformed
        RateLimiterInternalFrame frame = new RateLimiterInternalFrame(nf2, updateTimer,0);
        ((MDIDesktopPane)mainFrame.getDesktopPane()).add((JInternalFrame) frame);
    }//GEN-LAST:event_rateLimiterButtonActionPerformed

	private void rateLimiterButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rateLimiterButtonActionPerformed
        RateLimiterInternalFrame frame = new RateLimiterInternalFrame(nf2, updateTimer,1);
        ((MDIDesktopPane)mainFrame.getDesktopPane()).add((JInternalFrame) frame);
    }//GEN-LAST:event_rateLimiterButtonActionPerformed
	
	private void rateLimiterButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rateLimiterButtonActionPerformed
        RateLimiterInternalFrame frame = new RateLimiterInternalFrame(nf2, updateTimer,2);
        ((MDIDesktopPane)mainFrame.getDesktopPane()).add((JInternalFrame) frame);
    }//GEN-LAST:event_rateLimiterButtonActionPerformed

	private void rateLimiterButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rateLimiterButtonActionPerformed
        RateLimiterInternalFrame frame = new RateLimiterInternalFrame(nf2, updateTimer,3);
        ((MDIDesktopPane)mainFrame.getDesktopPane()).add((JInternalFrame) frame);
    }//GEN-LAST:event_rateLimiterButtonActionPerformed
...
// TODO: don't allow multiple instances of the same frame
    ...
    private javax.swing.JButton rateLimiterButton0;
    private javax.swing.JButton rateLimiterButton1;
    private javax.swing.JButton rateLimiterButton2;
    private javax.swing.JButton rateLimiterButton3;
